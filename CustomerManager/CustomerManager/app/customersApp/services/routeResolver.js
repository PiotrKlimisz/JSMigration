  ...
  var routeResolver = function() {
    ...
    this.route = (function(routeConfig) {
      var resolve = function(baseName, path, controllerAs, secure) {
          ...
          var routeDef = {};
          var baseFileName =
            baseName.charAt(0).toLowerCase() + baseName.substr(1);
          routeDef.templateUrl =
            routeConfig.getViewsDirectory() + path + baseFileName + '.html';
        ...
        resolveDependencies = function($q, $rootScope, dependencies) {
          ...
          console.log(dependencies);
            require.resolve(dependencies, function() {
              defer.resolve();
              $rootScope.$apply();
            });

        //   import(dependencies[0]).then(() => {
        //     console.log('import!!!');
        //     defer.resolve();
        //     $rootScope.$apply();
        //   });
